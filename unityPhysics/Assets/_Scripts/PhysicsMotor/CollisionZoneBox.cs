...
public class CollisionZoneBox : CollisionZone
{
    ...
    private Vector3 corner0, corner7;
    private CollisionZonePlane[] planes = new CollisionZonePlane[6];
    ...
    public override void initialateBound()
    {
        ...
        this.corner0 = new Vector3(bounds.center.x + bounds.extents.x, bounds.center.y + bounds.extents.y, bounds.center.z + bounds.extents.z);
        ...
        //y
        this.planes[0] = createPlane(corner0, corner1, corner4);//corner5
        this.planes[1] = createPlane(corner3, corner6, corner7);//corner2
        //x
        this.planes[2] = createPlane(corner3, corner1, corner0);//corner2
        this.planes[3] = createPlane(corner7, corner6, corner4);//corner5
        //z
        this.planes[4] = createPlane(corner0, corner4, corner6);//corner2
        this.planes[5] = createPlane(corner1, corner3, corner7);//corner5
    }
    ...
    public override Vector3 calculatePenaltyForce(Vector3 vertexPenalty)
    {
        ...
        Vector3 distance0 = this.corner0 - vertexPenalty;
        Vector3 distance1 = this.corner7 - vertexPenalty;
    ...
    private CollisionZonePlane createPlane(Vector3 v0, Vector3 v1, Vector3 v2)
    {
        ...
        plane.initPlane(v0, v1, v2, this.penaltyConstant, this.offset);
        return plane;
    }
